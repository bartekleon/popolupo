...
function initialiseGui()
{
    ...
    gui.add(robots[0].proximitySensorReading,"left",0, 15).listen();
    gui.add(robots[0].proximitySensorReading,"right",0, 15).listen();
    gui.add(robots[0].proximitySensorReading,"front",0, 15).listen();
 ...
 */
Simulator.prototype.addRamp = function(x,y, slope)
{
    ...
    body.quaternion.setFromAxisAngle(new CANNON.Vec3(0,1,0),THREE.Math.degToRad(slope));
    world.addBody(body);
    demo.addVisual(body);
}
