const updateTime = 40; // update time in ms
/**
...
function Tracy(x,y,z)
{
    ...
    /* Calculate acceleration and update its readings every updateTime ms */
    ...
    setInterval(updateAccelerometerReadings.bind(this), updateTime);

    /* Update proximity sensors readings every updateTime ms */
    ...
    setInterval(updateProximitySensorReadings.bind(this), updateTime);


    /* Update gyroscope sensor readings every updateTime ms */
    this.orientation = {
        x: 0,
        y: 0,
        z: 0
    ...
    setInterval(updateGyroscopeReadings.bind(this), updateTime);
}
...
Tracy.prototype.getProximitySensorReading = function()
{
    ...
    sensorReadings.right = getSensorReading(-sensorHalfAngle, sensorHalfAngle);
